...
### Učitavnje baze podataka

Za uspješno izvršavanje zadatka na phpMyAdmin stanici potrebno je uključiti bazu podataka korištenu za ovaj zadatak. Navedneo je moguće ostvariti uvozom (engl. _import_) postojeće baze podataka tako što untar odjeljka **new** odaberemo opciju **Import** te priložimo **web_market.sql** datoteku koja se nalazi unutar ovog direktorija. Pokretanjem SQL upita koji se nalaze u ovoj datoteci trebale bi se stvoriti baza podataka **web_market** kao i popratne tablice.
